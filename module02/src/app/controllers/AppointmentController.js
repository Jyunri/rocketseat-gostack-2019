...
class AppointmentController {
  async index(req, res) {
    ...
    const appointment = await Appointment.findxAll({
  ...
  async store(req, res) {
    ...
    /**
     * Check if user is not appointing himself
     */
    const checkUserIsProvider = req.userId === provider_id;
  ...
  async delete(req, res) {
    ...
    /**
     * Check if canceling is being made two hours before the appointment date
     */
